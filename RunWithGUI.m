...
classdef RunWithGUI < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function outputInExperiment(app)
            ...
            t = ["", "Offline Error", "Average Error Before Change", "Run Time(s)"];
            for i = 1:app.RunNumber
                t = [t; "Run #"+ i, app.E_o2.AllResults(i), app.E_bbc2.AllResults(i), app.T_r2.AllResults(i)];
            end
            temp = ["Average", app.E_o2.mean, app.E_bbc2.mean, app.T_r2.mean;
            "Median", app.E_o2.median, app.E_bbc2.median, app.T_r2.median;
            "Standard Error", app.E_o2.StdErr, app.E_bbc2.StdErr, app.T_r2.StdErr;];
            t = cat(1, t, temp);
            app.UITable.Data = t;
