...
%**************************************************************************************************
function [Swarm,Problem] = SubPopulationGenerator_CDE(Dimension,MinCoordinate,MaxCoordinate,NumPop,IndivSize,Problem,DiversityFlag,RandomFlag,StrategyFlag)
%% create swarms
