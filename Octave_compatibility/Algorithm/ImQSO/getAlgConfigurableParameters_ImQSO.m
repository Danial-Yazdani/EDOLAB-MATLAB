function ConfigurableParameters = getAlgConfigurableParameters_ImQSO()
    ...
    ConfigurableParameters.SwarmNumber = struct( ...
        ...
        'type', 'integer', ...
        'range', [0, 100], ...
        'description', 'Number of independent sub-swarms in the population.');

    % alpha: Controls the sensitivity of exclusion probability.
    ConfigurableParameters.alpha = struct( ...
        'value', 1, ...
        'type', 'integer', ...
        'range', [0, 10], ...
        'description', 'Exponent that controls how sharply exclusion probability changes with distance.');
end