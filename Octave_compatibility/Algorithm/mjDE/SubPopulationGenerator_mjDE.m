...
%*****************************************************************************************
function [Optimizer,Problem] = SubPopulationGenerator_mjDE(Dimension,MinCoordinate,MaxCoordinate,PopulationSize,Problem)
...
if Problem.RecentChange == 0
    [Optimizer.BestValue,Optimizer.GbestID] = max(Optimizer.FitnessValue);
    Optimizer.BestPosition = Optimizer.X(Optimizer.GbestID,:);
else
